...
public class MybatisGeneratorAdmin {
    ...
    public void generate() {
        ...
        FastAutoGenerator.create("jdbc:mysql://localhost/wsc_admin?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=GMT%2B8&useTimezone=true", "root", "root")
