package com.zhenmei.wsc.security.config;
...
@Configuration
@Slf4j
@MapperScan(basePackages = {"com.zhenmei.wsc.security.mybatis.generate.mapper", "com.zhenmei.wsc.security.mybatis.custom.mapper"})
public class DataSourceConfiguration {
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier("securityDataSource") DataSource customDataSource) throws Exception {
    ...
    public Resource[] resolveMapperLocations() {
        ...
        mapperLocations.add("classpath:com/zhenmei/wsc/security/mybatis/custom/mapper/xml/*.xml");
        mapperLocations.add("classpath:com/zhenmei/wsc/security/mybatis/generate/mapper/xml/*.xml");
